                    ...
                    {isActive.id === 1 &&
                        <>
                            ...
                            <div style={{ display: "flex", justifyContent: "space-between", padding: "20px 20px", gap: "20px" }}>
                                ...
                                <div style={{ display: "flex", alignItems: "center", gap: "10px", width: "50%", justifyContent: "end" }}>
                                    <button style={{ backgroundColor: "#1E85F1", borderRadius: "10px", padding: "12px 16px", border: "none", fontSize: "16px", fontWeight: "bold", color: "#FFF", cursor: "pointer" }}>Set duration rate</button>
                                    <button style={{ display: "flex", flexDirection: "row", gap: "6px", alignItems: "center", backgroundColor: "#1E85F1", borderRadius: "10px", padding: "12px 16px", border: "none", cursor: "pointer" }}>
